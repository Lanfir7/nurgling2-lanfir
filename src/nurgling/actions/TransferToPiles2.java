...
public class TransferToPiles2 implements Action {
    ...
    public TransferToPiles2(Pair<Coord2d, Coord2d> out, NAlias items) {
        this.out = out;
        this.items = items;
    }

    // Конструктор с фильтром по качеству
    public TransferToPiles2(Pair<Coord2d, Coord2d> out, NAlias items, Integer th) {
        this.out = out;
        this.items = items;
        this.th = th;
    }
